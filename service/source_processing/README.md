...
project/
├── src/
│   ├── source_loader.py      # Модуль загрузки и нормализации
│   └── source_mapper.py      # Модуль фильтрации колонок по ERD
├── test_files/               # Папка с исходными файлами
│   └── ваш_файл.xlsx
├── output/                   # Папка с результатами
│   ├── standard_<имя>_<дата>.xlsx    # Результат source_loader
│   └── filtered_<имя>_<дата>.xlsx    # Результат source_mapper
└── README.md
```
