...
COLUMN_MAPPING = {
    ...
    'short_name': ['Сокращенное наименование', 'Краткое наименование', 'Название краткое', 'Short name'],
    'full_name': ['Полное наименование', 'Наименование организации', 'Название организации', 'Полное название', 
                  'Наименование юр лица', 'Компания', 'Full name', 'Название'],
    'company_name': ['Наименование', 'Название', 'Название компании', 'Наименование компании'],
    'company_name_normalized': ['Нормализованное название', 'Название без ОПФ', 'Короткое имя'],
    ...
    'address': ['Адрес', 'Юридический адрес', 'Фактический адрес', 'Адрес организации'],
    ...
    'phone': ['Телефон', 'Телефоны', 'Мобильный телефон', 'Сотовый', 
              ...
              'Рабочий телефон', 'Телефон основной'],
    'contact_phone_mobile': ['Мобильный', 'Мобильный телефон', 'Мобильный номер', 'Сотовый телефон'],
