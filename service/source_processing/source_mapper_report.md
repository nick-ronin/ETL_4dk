...
```python
from SourceLoader.src.source_mapper import process_file, MVP_COLUMNS
...
- `output_folder` (str) — если указан, сохранит Excel в эту папку (для отладки/экспорта)

**Возвращает:**
- `dict` с итоговым `df`, статистикой фильтрации и статусом валидации
...
| **exporter** | Используется для опционального сохранения в Excel |
